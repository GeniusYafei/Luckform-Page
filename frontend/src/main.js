...
const createJobCard = (job) => {
    ...
    likeListContainer.className = 'like-list hide'; // hidden initially
    card.appendChild(likeListContainer);
    ...
    card.appendChild(showLikesButton);
    ...
    if (isHidden) {
        // Clear and rebuild the like list
        while (likeListContainer.firstChild) {
        likeListContainer.removeChild(likeListContainer.firstChild);
        }
    ...
    card.appendChild(commentListContainer);
    ...
    card.appendChild(showCommentsButton);
